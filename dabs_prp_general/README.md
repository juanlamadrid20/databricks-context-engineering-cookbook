...
The 'dabs_prp_general' project was generated by using the default-python template.
...
3. To deploy a development copy of this project, type:
    ...
    `[dev yourname] dabs_prp_general_job` to your workspace.
...
4. Similarly, to deploy a production copy, type:
   ...
   (defined in resources/dabs_prp_general.job.yml). The schedule
