...
def bronze_claims_quality_metrics():
    ...
    return (
        ...
        .agg(
            ...
            spark_sum(col("claim_amount").cast("double")).alias("total_claim_amount"),
            avg(col("claim_amount").cast("double")).alias("avg_claim_amount"),
            spark_min(col("claim_amount").cast("double")).alias("min_claim_amount"),
            spark_max(col("claim_amount").cast("double")).alias("max_claim_amount"),
